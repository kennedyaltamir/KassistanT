const PROVIDER_DEFINITIONS = [
  {
    ...
    validation: { capability: 'UNAVAILABLE', endpoint: null },
  },
  {
    provider: 'groq',
    label: 'Groq',
    credentialKeys: ['GROQ_API_KEY'],
    validation: { capability: 'SUPPORTED', endpoint: 'https://api.groq.com/openai/v1/models' },
  },
  {
    provider: 'mistral',
    label: 'Mistral',
    credentialKeys: ['MISTRAL_API_KEY'],
    validation: { capability: 'SUPPORTED', endpoint: 'https://api.mistral.ai/v1/models' },
  },
  {
    provider: 'cohere',
    label: 'Cohere',
    credentialKeys: ['COHERE_API_KEY'],
    validation: { capability: 'SUPPORTED', endpoint: 'https://api.cohere.com/v1/models' },
  },
  {
    provider: 'cerebras',
    label: 'Cerebras',
    credentialKeys: ['CEREBRAS_API_KEY'],
    validation: { capability: 'SUPPORTED', endpoint: 'https://api.cerebras.ai/v1/models' },
  },
  {
    provider: 'huggingface',
    label: 'Hugging Face',
    credentialKeys: ['HUGGINGFACE_API_KEY'],
    validation: { capability: 'SUPPORTED', endpoint: 'https://huggingface.co/api/whoami-v2' },
  },
  {
    provider: 'penrouter',
    label: 'PenRouter',
  ...
  },
  {
    ...
    validation: { capability: 'SUPPORTED', endpoint: 'https://api.github.com/user' },
  },
  {
    provider: 'sambanova',
    label: 'SambaNova',
    credentialKeys: ['SAMBANOVA_API_KEY'],
    validation: { capability: 'SUPPORTED', endpoint: 'https://api.sambanova.ai/v1/models' },
  },
];
