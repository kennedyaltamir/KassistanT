...
- CUSTOMER_UI_C1A: PARTIALLY_IMPLEMENTED
...
- PHONE_SEARCH_STATUS: UNAVAILABLE without a real or explicitly provisional source capable of the requested lookup. The UI never claims canonical lookup.
