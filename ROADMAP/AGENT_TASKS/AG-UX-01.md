# AG-UX-01 — Implementation Task Packet v1.0
...
- `packages/contracts/**`
- IA-05/IA-07 implementation paths unless explicitly coordinated

**Dependencies**
- D-006 Decision Log entry
- canonical terminology document
- existing UI navigation and renderer state
...
- screenshots/evidence demonstrate affected surfaces
